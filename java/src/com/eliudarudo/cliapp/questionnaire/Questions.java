...
public class Questions {
    public static Question[] fetchFrontendQuestions() {
        /*
            Using Question[] <- immutable Array because it allows
            initializing arrays within an object.
            The rest don't have simple initializers except array.add(Object o)
        */
        Question[] frontendQuestions = {
                new Question(
    ...
    public static Question[] fetchBackendQuestions() {
        Question[] backendQuestions = {
                new Question(
    ...
    public static Question[] fetchDevopsQuestions() {
        Question[] devopsQuestions = {
                new Question(
    ...
    public static Question[] fetchMobileQuestions() {
        Question[] mobileQuestions = {
                new Question(
